\documentclass[
    ...
    \begin{document}
      \maketitle
        ...
        % ######
        % The goal of this section is, that you document your idea of the table of contents. 
        % Please keep in mind: a well created table of contents is able to provide a good 
        % overview of the overall chain of reasoning of your work. This makes it very valuable.
        % 
        % Please include:
        %  - names of sections and subsections (please don't go deeper than that unless 
        %    your supervisor asks you for it)
        %  - a brief descriptions of the proposed content of each section and subsection
        %    (1-3 sentences)
        % 
        \begin{enumerate}
        ...
        \sectionSource{\lang}
        \sectionSourceDescription{\lang}Bitte fügen Sie hier 10-15 Quellen ein die Sie für Ihr Paper verwenden möchten.
        Formatierungsvorschlag:

        % ##########################################
        % # Overview of identified relevant work
        % ######
        % The goal of this section is, that you give an overview of the related work that 
        % you have identified so far. Make sure that your cited sources are of appropriate
        % quality.
        % 
        % Please include:
